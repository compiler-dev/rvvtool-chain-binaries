...
enum opt_code
{
  ...
  OPT__param_sra_max_scalarization_size_Osize_ = 265,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 266,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 267,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 268,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 269,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 270,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_merging_allow_unaligned_ = 271,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 272,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 273,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_tm_max_aggregate_size_ = 274,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 275,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 276, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 277,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 278,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 279,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 280, /* --param=tracer-min-branch-ratio= */
  OPT__param_tree_reassoc_width_ = 281,      /* --param=tree-reassoc-width= */
  OPT__param_uninit_control_dep_attempts_ = 282,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninlined_function_insns_ = 283,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 284, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 285,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 286,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 287,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 288,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 289,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 290,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 291,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 292,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_max_peeling_for_alignment_ = 293,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 294,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 295,/* --param=vect-max-version-for-alignment-checks= */
  /* OPT__pass_exit_codes = 296, */          /* --pass-exit-codes */
  /* OPT__pedantic = 297, */                 /* --pedantic */
  /* OPT__pedantic_errors = 298, */          /* --pedantic-errors */
  /* OPT__pie = 299, */                      /* --pie */
  /* OPT__pipe = 300, */                     /* --pipe */
  /* OPT__prefix = 301, */                   /* --prefix */
  /* OPT__prefix_ = 302, */                  /* --prefix= */
  /* OPT__preprocess = 303, */               /* --preprocess */
  /* OPT__print_file_name = 304, */          /* --print-file-name */
  /* OPT__print_file_name_ = 305, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 306, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 307, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 308, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 309, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 310, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 311, */          /* --print-multiarch */
  /* OPT__print_prog_name = 312, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 313, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 314, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 315, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 316, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 317, */                  /* --profile */
  /* OPT__save_temps = 318, */               /* --save-temps */
  /* OPT__shared = 319, */                   /* --shared */
  /* OPT__specs = 320, */                    /* --specs */
  /* OPT__specs_ = 321, */                   /* --specs= */
  /* OPT__static = 322, */                   /* --static */
  /* OPT__static_pie = 323, */               /* --static-pie */
  /* OPT__symbolic = 324, */                 /* --symbolic */
  /* OPT__sysroot = 325, */                  /* --sysroot */
  OPT__sysroot_ = 326,                       /* --sysroot= */
  OPT__target_help = 327,                    /* --target-help */
  /* OPT__time = 328, */                     /* --time */
  /* OPT__trace_includes = 329, */           /* --trace-includes */
  /* OPT__traditional = 330, */              /* --traditional */
  /* OPT__traditional_cpp = 331, */          /* --traditional-cpp */
  /* OPT__trigraphs = 332, */                /* --trigraphs */
  /* OPT__undefine_macro = 333, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 334, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 335, */        /* --user-dependencies */
  /* OPT__verbose = 336, */                  /* --verbose */
  OPT__version = 337,                        /* --version */
  /* OPT__write_dependencies = 338, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 339, */  /* --write-user-dependencies */
  OPT_A = 340,                               /* -A */
  OPT_B = 341,                               /* -B */
  OPT_C = 342,                               /* -C */
  OPT_CC = 343,                              /* -CC */
  ...
  OPT_Tbss_ = 375,                           /* -Tbss= */
  OPT_Tdata = 376,                           /* -Tdata */
  OPT_Tdata_ = 377,                          /* -Tdata= */
  OPT_Ttext = 378,                           /* -Ttext */
  OPT_Ttext_ = 379,                          /* -Ttext= */
  OPT_U = 380,                               /* -U */
  /* OPT_W = 381, */                         /* -W */
  OPT_Wa_ = 382,                             /* -Wa, */
  OPT_Wabi = 383,                            /* -Wabi */
  OPT_Wabi_tag = 384,                        /* -Wabi-tag */
  OPT_Wabi_ = 385,                           /* -Wabi= */
  OPT_Wabsolute_value = 386,                 /* -Wabsolute-value */
  OPT_Waddress = 387,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 388,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 389,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 390,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 391,                       /* -Waliasing */
  OPT_Walign_commons = 392,                  /* -Walign-commons */
  /* OPT_Waligned_new = 393, */              /* -Waligned-new */
  OPT_Waligned_new_ = 394,                   /* -Waligned-new= */
  OPT_Wall = 395,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 396,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 397,                     /* -Walloc-zero */
  OPT_Walloca = 398,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 399,            /* -Walloca-larger-than= */
  OPT_Wampersand = 400,                      /* -Wampersand */
  OPT_Wanalyzer_double_fclose = 401,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 402,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 403,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_file_leak = 404,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 405,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_malloc_leak = 406,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_null_argument = 407,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 408,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_possible_null_argument = 409,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 410,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_stale_setjmp_buffer = 411,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_array_index = 412,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_too_complex = 413,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 414,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 415,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 416,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 417,/* -Wanalyzer-use-of-uninitialized-value */
  ...
  /* OPT_Wno_vla_larger_than = 584, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 585,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 586,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 587,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 588,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 589,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 590,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 591, */               /* -Wnormalized */
  OPT_Wnormalized_ = 592,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 593,               /* -Wnull-dereference */
  OPT_Wodr = 594,                            /* -Wodr */
  OPT_Wold_style_cast = 595,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 596,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 597,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 598,                    /* -Wopenmp-simd */
  OPT_Woverflow = 599,                       /* -Woverflow */
  OPT_Woverlength_strings = 600,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 601,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 602,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 603,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 604,            /* -Woverwrite-recursive */
  OPT_Wp_ = 605,                             /* -Wp, */
  OPT_Wpacked = 606,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 607,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 608,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 609,                         /* -Wpadded */
  OPT_Wparentheses = 610,                    /* -Wparentheses */
  OPT_Wpedantic = 611,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 612,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 613, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 614,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 615,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 616,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 617,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 618,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 619,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 620,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 621,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 622,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 623,                       /* -Wprotocol */
  OPT_Wpsabi = 624,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 625,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 626,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 627,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 628,                /* -Wredundant-decls */
  OPT_Wredundant_move = 629,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 630,                 /* -Wredundant-tags */
  OPT_Wregister = 631,                       /* -Wregister */
  OPT_Wreorder = 632,                        /* -Wreorder */
  OPT_Wrestrict = 633,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 634,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 635,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 636,           /* -Wscalar-storage-order */
  OPT_Wselector = 637,                       /* -Wselector */
  OPT_Wsequence_point = 638,                 /* -Wsequence-point */
  OPT_Wshadow = 639,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 640, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 641,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 642, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 643,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 644, */            /* -Wshadow=global */
  OPT_Wshadow_local = 645,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 646,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 647,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 648,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 649, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 650,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 651,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 652,                /* -Wsign-conversion */
  OPT_Wsign_promo = 653,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 654,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 655,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 656,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 657,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 658,                    /* -Wspeculative */
  OPT_Wstack_protector = 659,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 660,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 661,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 662,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 663,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 664,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 665,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 666,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 667,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 668,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 669, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 670,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 671,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 672,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 673,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 674,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 675,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 676,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 677,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 678,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 679,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 680,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 681,               /* -Wsuggest-override */
  OPT_Wsurprising = 682,                     /* -Wsurprising */
  OPT_Wswitch = 683,                         /* -Wswitch */
  OPT_Wswitch_bool = 684,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 685,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 686,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 687,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 688,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 689,                      /* -Wsync-nand */
  OPT_Wsynth = 690,                          /* -Wsynth */
  OPT_Wsystem_headers = 691,                 /* -Wsystem-headers */
  OPT_Wtabs = 692,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 693,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 694,           /* -Wtautological-compare */
  OPT_Wtemplates = 695,                      /* -Wtemplates */
  OPT_Wterminate = 696,                      /* -Wterminate */
  OPT_Wtraditional = 697,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 698,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 699,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 700,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 701,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 702,            /* -Wundeclared-selector */
  OPT_Wundef = 703,                          /* -Wundef */
  OPT_Wundefined_do_loop = 704,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 705,                      /* -Wunderflow */
  OPT_Wuninitialized = 706,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 707,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 708, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 709, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 710,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 711,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 712,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 713,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 714, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 715,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 716,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 717,                /* -Wunused-function */
  OPT_Wunused_label = 718,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 719,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 720,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 721,               /* -Wunused-parameter */
  OPT_Wunused_result = 722,                  /* -Wunused-result */
  OPT_Wunused_value = 723,                   /* -Wunused-value */
  OPT_Wunused_variable = 724,                /* -Wunused-variable */
  OPT_Wuse_without_only = 725,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 726,                   /* -Wuseless-cast */
  OPT_Wvarargs = 727,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 728,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 729,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 730,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 731,            /* -Wvirtual-move-assign */
  OPT_Wvla = 732,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 733,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 734,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 735,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 736,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 737,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 738,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 739,                       /* -Wzerotrip */
  OPT_X = 740,                               /* -X */
  OPT_Xassembler = 741,                      /* -Xassembler */
  OPT_Xf = 742,                              /* -Xf */
  OPT_Xlinker = 743,                         /* -Xlinker */
  OPT_Xpreprocessor = 744,                   /* -Xpreprocessor */
  OPT_Z = 745,                               /* -Z */
  OPT_ansi = 746,                            /* -ansi */
  OPT_aux_info = 747,                        /* -aux-info */
  /* OPT_aux_info_ = 748, */                 /* -aux-info= */
  OPT_auxbase = 749,                         /* -auxbase */
  OPT_auxbase_strip = 750,                   /* -auxbase-strip */
  OPT_c = 751,                               /* -c */
  OPT_callgraph = 752,                       /* -callgraph */
  OPT_coverage = 753,                        /* -coverage */
  OPT_cpp = 754,                             /* -cpp */
  OPT_cpp_ = 755,                            /* -cpp= */
  OPT_d = 756,                               /* -d */
  OPT_debuglib_ = 757,                       /* -debuglib= */
  OPT_defaultlib_ = 758,                     /* -defaultlib= */
  OPT_defined_only = 759,                    /* -defined-only */
  OPT_demangle = 760,                        /* -demangle */
  OPT_dstartfiles = 761,                     /* -dstartfiles */
  OPT_dump_body_ = 762,                      /* -dump-body= */
  OPT_dump_level_ = 763,                     /* -dump-level= */
  OPT_dumpbase = 764,                        /* -dumpbase */
  OPT_dumpdir = 765,                         /* -dumpdir */
  OPT_dumpfullversion = 766,                 /* -dumpfullversion */
  OPT_dumpmachine = 767,                     /* -dumpmachine */
  OPT_dumpspecs = 768,                       /* -dumpspecs */
  OPT_dumpversion = 769,                     /* -dumpversion */
  OPT_e = 770,                               /* -e */
  OPT_export_dynamic = 771,                  /* -export-dynamic */
  OPT_fPIC = 772,                            /* -fPIC */
  OPT_fPIE = 773,                            /* -fPIE */
  OPT_fRTS_ = 774,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 775,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 776,                   /* -fabi-version= */
  OPT_faccess_control = 777,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 778,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 779,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 780,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 781,                  /* -falign-commons */
  OPT_falign_functions = 782,                /* -falign-functions */
  OPT_falign_functions_ = 783,               /* -falign-functions= */
  OPT_falign_jumps = 784,                    /* -falign-jumps */
  OPT_falign_jumps_ = 785,                   /* -falign-jumps= */
  OPT_falign_labels = 786,                   /* -falign-labels */
  OPT_falign_labels_ = 787,                  /* -falign-labels= */
  OPT_falign_loops = 788,                    /* -falign-loops */
  OPT_falign_loops_ = 789,                   /* -falign-loops= */
  /* OPT_faligned_new = 790, */              /* -faligned-new */
  OPT_faligned_new_ = 791,                   /* -faligned-new= */
  OPT_fall_instantiations = 792,             /* -fall-instantiations */
  OPT_fall_intrinsics = 793,                 /* -fall-intrinsics */
  OPT_fall_virtual = 794,                    /* -fall-virtual */
  OPT_fallocation_dce = 795,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 796,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 797,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 798,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 799,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 800,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 801,         /* -falt-external-templates */
  OPT_fanalyzer = 802,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 803,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 804,              /* -fanalyzer-checker= */
  OPT_fanalyzer_fine_grained = 805,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 806,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 807,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 808,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 809,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 810,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 811, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 812,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 813, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 814, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 815, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 816, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 817,            /* -fasan-shadow-offset= */
  OPT_fasm = 818,                            /* -fasm */
  OPT_fassert = 819,                         /* -fassert */
  OPT_fassociative_math = 820,               /* -fassociative-math */
  OPT_fassume_phsa = 821,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 822,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 823,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 824,                   /* -fauto-profile */
  OPT_fauto_profile_ = 825,                  /* -fauto-profile= */
  OPT_fautomatic = 826,                      /* -fautomatic */
  OPT_fbackslash = 827,                      /* -fbackslash */
  OPT_fbacktrace = 828,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 829,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 830,                   /* -fbounds-check */
  OPT_fbounds_check_ = 831,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 832,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 833,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 834, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 835, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 836, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 837,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 838,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 839,                        /* -fbuiltin */
  OPT_fbuiltin_ = 840,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 841,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 842,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 843,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 844,                    /* -fcall-saved- */
  OPT_fcall_used_ = 845,                     /* -fcall-used- */
  OPT_fcaller_saves = 846,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 847,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 848,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 849,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 850, */            /* -fcf-protection */
  OPT_fcf_protection_ = 851,                 /* -fcf-protection= */
  OPT_fchar8_t = 852,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 853,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 854, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 855,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 856,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 857,                         /* -fcheck= */
  OPT_fchecking = 858,                       /* -fchecking */
  OPT_fchecking_ = 859,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 860,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 861,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 862,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 863,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 864,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 865,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 866,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 867,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 868, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 869,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 870,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 871,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 872, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 873,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 874,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 875,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 876,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 877,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 878, */                 /* -fcilkplus */
  OPT_fcoarray_ = 879,                       /* -fcoarray= */
  OPT_fcode_hoisting = 880,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 881,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 882,                         /* -fcommon */
  OPT_fcompare_debug = 883,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 884,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 885,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 886,                   /* -fcompare-elim */
  OPT_fconcepts = 887,                       /* -fconcepts */
  OPT_fconcepts_ts = 888,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 889,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 890, */           /* -fconserve-space */
  OPT_fconserve_stack = 891,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 892,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 893,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 894,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 895,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 896,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 897,                       /* -fconvert= */
  OPT_fcoroutines = 898,                     /* -fcoroutines */
  OPT_fcprop_registers = 899,                /* -fcprop-registers */
  OPT_fcray_pointer = 900,                   /* -fcray-pointer */
  OPT_fcrossjumping = 901,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 902,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 903, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 904,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 905,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 906,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 907,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 908,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 909,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 910,                       /* -fdbg-cnt= */
  OPT_fdce = 911,                            /* -fdce */
  OPT_fdebug = 912,                          /* -fdebug */
  OPT_fdebug_cpp = 913,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 914,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 915,            /* -fdebug-types-section */
  OPT_fdebug_ = 916,                         /* -fdebug= */
  OPT_fdec = 917,                            /* -fdec */
  OPT_fdec_blank_format_item = 918,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 919,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 920,            /* -fdec-format-defaults */
  OPT_fdec_include = 921,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 922,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 923,                       /* -fdec-math */
  OPT_fdec_static = 924,                     /* -fdec-static */
  OPT_fdec_structure = 925,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 926,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 927, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 928,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 929, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 930,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 931,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 932,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 933,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 934,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 935,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 936,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 937,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 938,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 939,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 940,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 941, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 942,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 943,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 944,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 945,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 946,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 947,       /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_show_caret = 948,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 949,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 950,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 951,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 952,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 953,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 954,   /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 955, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 956,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 957,                /* -fdirectives-only */
  OPT_fdisable_ = 958,                       /* -fdisable- */
  OPT_fdoc = 959,                            /* -fdoc */
  OPT_fdoc_dir_ = 960,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 961,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 962,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 963,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 964,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 965,                       /* -fdruntime */
  OPT_fdse = 966,                            /* -fdse */
  OPT_fdump_ = 967,                          /* -fdump- */
  OPT_fdump_ada_spec = 968,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 969,             /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 970,                  /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 971,        /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 972,   /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 973,   /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 974, /* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 975, /* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_state_purge = 976,      /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 977,           /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 978,       /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 979, */                /* -fdump-core */
  OPT_fdump_d_original = 980,                /* -fdump-d-original */
  OPT_fdump_final_insns = 981,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 982,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 983,            /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 984,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 985,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 986,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 987,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 988,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 989, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 990,                    /* -fdump-passes */
  OPT_fdump_scos = 991,                      /* -fdump-scos */
  OPT_fdump_unnumbered = 992,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 993,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 994,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 995,                 /* -fearly-inlining */
  OPT_felide_constructors = 996,             /* -felide-constructors */
  OPT_felide_type = 997,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 998, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 999, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1000,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1001,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1002,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1003,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1004,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1005,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1006,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1007,                /* -fenum-int-equiv */
  OPT_fexceptions = 1008,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1009,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1010,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1011,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1012,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1013,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1014,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1015,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1016,            /* -fexternal-templates */
  OPT_ff2c = 1017,                           /* -ff2c */
  OPT_ffast_math = 1018,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1019,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1020,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1021,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1022,              /* -ffinite-math-only */
  OPT_ffixed_ = 1023,                        /* -ffixed- */
  OPT_ffixed_form = 1024,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1025,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1026,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1027,                   /* -ffloat-store */
  OPT_ffor_scope = 1028,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1029, */              /* -fforce-addr */
  OPT_fforward_propagate = 1030,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1031,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1032,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1033,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1034,                     /* -ffpe-trap= */
  OPT_ffree_form = 1035,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1036,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1037,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1038,                  /* -ffreestanding */
  OPT_ffriend_injection = 1039,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1040,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1041,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1042,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1043,             /* -ffunction-sections */
  OPT_fgcse = 1044,                          /* -fgcse */
  OPT_fgcse_after_reload = 1045,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1046,                      /* -fgcse-las */
  OPT_fgcse_lm = 1047,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1048,                       /* -fgcse-sm */
  OPT_fgimple = 1049,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1050,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1051,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1052,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1053,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1054,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1055,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1056,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1057,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1058,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1059,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1060,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1061,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1062,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1063,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1064,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1065,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1066,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1067,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1068,                      /* -fgraphite */
  OPT_fgraphite_identity = 1069,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1070,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1071,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1072, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1073, */                    /* -fhelp */
  /* OPT_fhelp_ = 1074, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1075,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1076,                     /* -fhonor-std */
  OPT_fhosted = 1077,                        /* -fhosted */
  OPT_fhuge_objects = 1078,                  /* -fhuge-objects */
  OPT_fident = 1079,                         /* -fident */
  OPT_fif_conversion = 1080,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1081,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1082,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1083,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1084,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1085,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1086,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1087,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1088,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1089,               /* -finit-character= */
  OPT_finit_derived = 1090,                  /* -finit-derived */
  OPT_finit_integer_ = 1091,                 /* -finit-integer= */
  OPT_finit_local_zero = 1092,               /* -finit-local-zero */
  OPT_finit_logical_ = 1093,                 /* -finit-logical= */
  OPT_finit_real_ = 1094,                    /* -finit-real= */
  OPT_finline = 1095,                        /* -finline */
  OPT_finline_arg_packing = 1096,            /* -finline-arg-packing */
  OPT_finline_atomics = 1097,                /* -finline-atomics */
  OPT_finline_functions = 1098,              /* -finline-functions */
  OPT_finline_functions_called_once = 1099,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1100, */           /* -finline-limit- */
  OPT_finline_limit_ = 1101,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1102,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1103,        /* -finline-small-functions */
  OPT_finput_charset_ = 1104,                /* -finput-charset= */
  OPT_finstrument_functions = 1105,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1106,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1107,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1108,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1109,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1110,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1111,                    /* -finvariants */
  OPT_fipa_bit_cp = 1112,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1113,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1114, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1115,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1116,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1117,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1118,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1119, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1120,                   /* -fipa-profile */
  OPT_fipa_pta = 1121,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1122,                /* -fipa-pure-const */
  OPT_fipa_ra = 1123,                        /* -fipa-ra */
  OPT_fipa_reference = 1124,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1125,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1126,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1127,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1128, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1129,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1130,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1131,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1132,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1133,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1134,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1135,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1136,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1137,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1138,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1139,              /* -fivar-visibility= */
  OPT_fivopts = 1140,                        /* -fivopts */
  OPT_fjump_tables = 1141,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1142,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1143,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1144,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1145,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1146,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1147,                     /* -flabels-ok */
  OPT_flax_vector_conversions = 1148,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1149,            /* -fleading-underscore */
  OPT_flifetime_dse = 1150,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1151,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1152,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1153,                /* -flinker-output= */
  /* OPT_flive_patching = 1154, */           /* -flive-patching */
  OPT_flive_patching_ = 1155,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1156,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1157,                   /* -flocal-ivars */
  /* OPT_floop_block = 1158, */              /* -floop-block */
  /* OPT_floop_flatten = 1159, */            /* -floop-flatten */
  OPT_floop_interchange = 1160,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1161,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1162, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1163,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1164, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1165,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1166,                     /* -flra-remat */
  OPT_flto = 1167,                           /* -flto */
  OPT_flto_compression_level_ = 1168,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1169, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1170,                /* -flto-partition= */
  OPT_flto_report = 1171,                    /* -flto-report */
  OPT_flto_report_wpa = 1172,                /* -flto-report-wpa */
  OPT_flto_ = 1173,                          /* -flto= */
  OPT_fltrans = 1174,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1175,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1176,             /* -fmacro-prefix-map= */
  OPT_fmain = 1177,                          /* -fmain */
  OPT_fmath_errno = 1178,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1179,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1180,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1181,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1182,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1183,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1184,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1185,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1186,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1187,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1188,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1189,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1190,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1191,                  /* -fmodule-file= */
  OPT_fmodule_private = 1192,                /* -fmodule-private */
  OPT_fmoduleinfo = 1193,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1194,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1195,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1196,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1197,                 /* -fms-extensions */
  OPT_fmudflap = 1198,                       /* -fmudflap */
  OPT_fmudflapir = 1199,                     /* -fmudflapir */
  OPT_fmudflapth = 1200,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1201,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1202,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1203,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1204,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1205,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1206,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1207,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1208,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1209,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1210,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1211,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1212,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1213,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1214,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1215,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1216,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1217,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1218,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1219,                  /* -foffload-abi= */
  OPT_foffload_ = 1220,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1221,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1222,                         /* -fonly= */
  OPT_fopenacc = 1223,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1224,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1225,                        /* -fopenmp */
  OPT_fopenmp_simd = 1226,                   /* -fopenmp-simd */
  OPT_foperator_names = 1227,                /* -foperator-names */
  OPT_fopt_info = 1228,                      /* -fopt-info */
  OPT_fopt_info_ = 1229,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1230, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1231,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1232,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1233, */          /* -foptional-diags */
  OPT_fpack_derived = 1234,                  /* -fpack-derived */
  OPT_fpack_struct = 1235,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1236,                  /* -fpack-struct= */
  OPT_fpad_source = 1237,                    /* -fpad-source */
  OPT_fpartial_inlining = 1238,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1239,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1240,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1241,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1242,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1243,                    /* -fpeel-loops */
  OPT_fpeephole = 1244,                      /* -fpeephole */
  OPT_fpeephole2 = 1245,                     /* -fpeephole2 */
  OPT_fpermissive = 1246,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1247,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1248,                           /* -fpic */
  OPT_fpie = 1249,                           /* -fpie */
  OPT_fplan9_extensions = 1250,              /* -fplan9-extensions */
  OPT_fplt = 1251,                           /* -fplt */
  OPT_fplugin_arg_ = 1252,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1253,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1254,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1255,                /* -fpostconditions */
  OPT_fpre_include_ = 1256,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1257,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1258,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1259,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1260,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1261,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1262,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1263,           /* -fprintf-return-value */
  OPT_fprofile = 1264,                       /* -fprofile */
  OPT_fprofile_abs_path = 1265,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1266,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1267,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1268,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1269,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1270,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1271,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1272,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1273,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1274,      /* -fprofile-partial-training */
  OPT_fprofile_reorder_functions = 1275,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1276,                /* -fprofile-report */
  OPT_fprofile_reproducible = 1277,          /* -fprofile-reproducible */
  OPT_fprofile_update_ = 1278,               /* -fprofile-update= */
  OPT_fprofile_use = 1279,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1280,                  /* -fprofile-use= */
  OPT_fprofile_values = 1281,                /* -fprofile-values */
  OPT_fprotect_parens = 1282,                /* -fprotect-parens */
  OPT_frandom_seed = 1283,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1284,                  /* -frandom-seed= */
  OPT_frange_check = 1285,                   /* -frange-check */
  OPT_freal_4_real_10 = 1286,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1287,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1288,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1289,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1290,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1291,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1292,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1293,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1294,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1295,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1296,               /* -frecord-marker=8 */
  OPT_frecursive = 1297,                     /* -frecursive */
  OPT_free = 1298,                           /* -free */
  OPT_freg_struct_return = 1299,             /* -freg-struct-return */
  /* OPT_fregmove = 1300, */                 /* -fregmove */
  OPT_frelease = 1301,                       /* -frelease */
  OPT_frename_registers = 1302,              /* -frename-registers */
  OPT_freorder_blocks = 1303,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1304,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1305,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1306,             /* -freorder-functions */
  OPT_frepack_arrays = 1307,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1308,          /* -freplace-objc-classes */
  OPT_frepo = 1309,                          /* -frepo */
  OPT_freport_bug = 1310,                    /* -freport-bug */
  OPT_frequire_return_statement = 1311,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1312,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1313, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1314,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1315,                   /* -fresolution= */
  OPT_frounding_math = 1316,                 /* -frounding-math */
  OPT_frtti = 1317,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1318,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1319,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1320,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1321,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1322,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1323,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1324,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1325,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1326, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1327,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1328,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1329,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1330,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1331,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1332,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1333,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1334,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1335,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1336,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1337,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1338,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1339,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1340,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1341,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1342,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1343, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1344,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1345,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1346,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1347,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1348,               /* -fsection-anchors */
  /* OPT_fsee = 1349, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1350,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1351,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1352,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1353,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1354,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1355,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1356,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1357,                   /* -fshort-enums */
  OPT_fshort_wchar = 1358,                   /* -fshort-wchar */
  OPT_fshow_column = 1359,                   /* -fshow-column */
  OPT_fshrink_wrap = 1360,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1361,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1362,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1363,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1364,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1365,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1366,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1367,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1368,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1369,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1370,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1371,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1372,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1373,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1374,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1375,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1376,                      /* -fsquangle */
  OPT_fssa_backprop = 1377,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1378,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1379,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1380,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1381, */             /* -fstack-check */
  OPT_fstack_check_ = 1382,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1383,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1384,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1385,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1386,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1387,               /* -fstack-protector */
  OPT_fstack_protector_all = 1388,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1389,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1390,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1391,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1392,                   /* -fstack-usage */
  OPT_fstats = 1393,                         /* -fstats */
  OPT_fstdarg_opt = 1394,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1395,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1396, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1397,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1398,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1399,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1400,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1401,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1402, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1403,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1404,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1405,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1406,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1407,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1408, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1409,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1410, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1411,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1412, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1413,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1414,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1415,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1416,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1417,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1418,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1419,                   /* -ftime-report */
  OPT_ftime_report_details = 1420,           /* -ftime-report-details */
  OPT_ftls_model_ = 1421,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1422,              /* -ftoplevel-reorder */
  OPT_ftracer = 1423,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1424,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1425,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1426,                   /* -ftrampolines */
  OPT_ftransition_all = 1427,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1428,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1429,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1430,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1431,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1432,              /* -ftransition=field */
  OPT_ftransition_import = 1433,             /* -ftransition=import */
  OPT_ftransition_nogc = 1434,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1435,                /* -ftransition=tls */
  OPT_ftrapping_math = 1436,                 /* -ftrapping-math */
  OPT_ftrapv = 1437,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1438,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1439,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1440,                      /* -ftree-ccp */
  OPT_ftree_ch = 1441,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1442, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1443,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1444,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1445, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1446,                   /* -ftree-cselim */
  OPT_ftree_dce = 1447,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1448,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1449,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1450,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1451,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1452, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1453,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1454,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1455, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1456,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1457,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1458, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1459,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1460,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1461,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1462,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1463,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1464,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1465,                      /* -ftree-pre */
  OPT_ftree_pta = 1466,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1467,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1468, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1469,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1470,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1471,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1472,                     /* -ftree-slsr */
  OPT_ftree_sra = 1473,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1474, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1475, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1476,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1477,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1478,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1479, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1480,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1481, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1482,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1483,         /* -funconstrained-commons */
  OPT_funderscoring = 1484,                  /* -funderscoring */
  OPT_funit_at_a_time = 1485,                /* -funit-at-a-time */
  OPT_funittest = 1486,                      /* -funittest */
  OPT_funroll_all_loops = 1487,              /* -funroll-all-loops */
  OPT_funroll_loops = 1488,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1489, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1490,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1491,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1492,                 /* -funsigned-char */
  OPT_funswitch_loops = 1493,                /* -funswitch-loops */
  OPT_funwind_tables = 1494,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1495,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1496,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1497,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1498,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1499,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1500,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1501,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1502,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1503,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1504,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1505,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1506, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1507,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1508,                   /* -fverbose-asm */
  /* OPT_fversion = 1509, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1510,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1511,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1512,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1513,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1514,                   /* -fvisibility= */
  OPT_fvpt = 1515,                           /* -fvpt */
  OPT_fvtable_gc = 1516,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1517,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1518,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1519,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1520,                     /* -fvtv-debug */
  OPT_fweak = 1521,                          /* -fweak */
  OPT_fweb = 1522,                           /* -fweb */
  /* OPT_fwhole_file = 1523, */              /* -fwhole-file */
  OPT_fwhole_program = 1524,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1525,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1526,             /* -fworking-directory */
  OPT_fwpa = 1527,                           /* -fwpa */
  OPT_fwpa_ = 1528,                          /* -fwpa= */
  OPT_fwrapv = 1529,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1530,                 /* -fwrapv-pointer */
  OPT_fxref = 1531,                          /* -fxref */
  /* OPT_fzee = 1532, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1533,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1534,                     /* -fzero-link */
  OPT_g = 1535,                              /* -g */
  OPT_gant = 1536,                           /* -gant */
  OPT_gas_loc_support = 1537,                /* -gas-loc-support */
  OPT_gas_locview_support = 1538,            /* -gas-locview-support */
  OPT_gcoff = 1539,                          /* -gcoff */
  OPT_gcoff1 = 1540,                         /* -gcoff1 */
  OPT_gcoff2 = 1541,                         /* -gcoff2 */
  OPT_gcoff3 = 1542,                         /* -gcoff3 */
  OPT_gcolumn_info = 1543,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1544,                 /* -gdescribe-dies */
  OPT_gdwarf = 1545,                         /* -gdwarf */
  OPT_gdwarf_ = 1546,                        /* -gdwarf- */
  OPT_gen_decls = 1547,                      /* -gen-decls */
  OPT_ggdb = 1548,                           /* -ggdb */
  OPT_ggnu_pubnames = 1549,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1550,                   /* -gimple-stats */
  OPT_ginline_points = 1551,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1552, /* -ginternal-reset-location-views */
  OPT_gnat = 1553,                           /* -gnat */
  OPT_gnatO = 1554,                          /* -gnatO */
  OPT_gno_ = 1555,                           /* -gno- */
  OPT_gno_pubnames = 1556,                   /* -gno-pubnames */
  OPT_gpubnames = 1557,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1558,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1559,                   /* -gsplit-dwarf */
  OPT_gstabs = 1560,                         /* -gstabs */
  OPT_gstabs_ = 1561,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1562,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1563,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1564,                        /* -gtoggle */
  OPT_gvariable_location_views = 1565,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1566,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1567,                           /* -gvms */
  OPT_gxcoff = 1568,                         /* -gxcoff */
  OPT_gxcoff_ = 1569,                        /* -gxcoff+ */
  OPT_gz = 1570,                             /* -gz */
  OPT_gz_ = 1571,                            /* -gz= */
  OPT_h = 1572,                              /* -h */
  OPT_help = 1573,                           /* -help */
  OPT_idirafter = 1574,                      /* -idirafter */
  OPT_imacros = 1575,                        /* -imacros */
  OPT_imultiarch = 1576,                     /* -imultiarch */
  OPT_imultilib = 1577,                      /* -imultilib */
  OPT_include = 1578,                        /* -include */
  OPT_iplugindir_ = 1579,                    /* -iplugindir= */
  OPT_iprefix = 1580,                        /* -iprefix */
  OPT_iquote = 1581,                         /* -iquote */
  OPT_isysroot = 1582,                       /* -isysroot */
  OPT_isystem = 1583,                        /* -isystem */
  OPT_iwithprefix = 1584,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1585,              /* -iwithprefixbefore */
  OPT_k8 = 1586,                             /* -k8 */
  OPT_l = 1587,                              /* -l */
  OPT_lang_asm = 1588,                       /* -lang-asm */
  OPT_list = 1589,                           /* -list */
  OPT_mabi_ = 1590,                          /* -mabi= */
  OPT_malign_data_ = 1591,                   /* -malign-data= */
  OPT_march_ = 1592,                         /* -march= */
  OPT_mbranch_cost_ = 1593,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1594,                       /* -mcmodel= */
  OPT_mdiv = 1595,                           /* -mdiv */
  OPT_mexplicit_relocs = 1596,               /* -mexplicit-relocs */
  OPT_mfdiv = 1597,                          /* -mfdiv */
  OPT_mplt = 1598,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1599,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1600,                         /* -mrelax */
  OPT_mriscv_attribute = 1601,               /* -mriscv-attribute */
  OPT_msave_restore = 1602,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1603,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1604,                  /* -mstrict-align */
  OPT_mtune_ = 1605,                         /* -mtune= */
  OPT_n = 1606,                              /* -n */
  OPT_name_sort = 1607,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1608,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1609,              /* -no-integrated-cpp */
  OPT_no_pie = 1610,                         /* -no-pie */
  OPT_nocpp = 1611,                          /* -nocpp */
  OPT_nodefaultlibs = 1612,                  /* -nodefaultlibs */
  OPT_nolibc = 1613,                         /* -nolibc */
  OPT_nophoboslib = 1614,                    /* -nophoboslib */
  OPT_nostartfiles = 1615,                   /* -nostartfiles */
  OPT_nostdinc = 1616,                       /* -nostdinc */
  OPT_nostdinc__ = 1617,                     /* -nostdinc++ */
  OPT_nostdlib = 1618,                       /* -nostdlib */
  OPT_o = 1619,                              /* -o */
  OPT_objects = 1620,                        /* -objects */
  OPT_p = 1621,                              /* -p */
  OPT_pass_exit_codes = 1622,                /* -pass-exit-codes */
  /* OPT_pedantic = 1623, */                 /* -pedantic */
  OPT_pedantic_errors = 1624,                /* -pedantic-errors */
  OPT_pg = 1625,                             /* -pg */
  OPT_pie = 1626,                            /* -pie */
  OPT_pipe = 1627,                           /* -pipe */
  OPT_print_file_name_ = 1628,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1629,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1630,          /* -print-multi-directory */
  OPT_print_multi_lib = 1631,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1632,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1633,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1634,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1635,               /* -print-prog-name= */
  OPT_print_search_dirs = 1636,              /* -print-search-dirs */
  OPT_print_sysroot = 1637,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1638,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1639,                    /* -print-value */
  OPT_quiet = 1640,                          /* -quiet */
  OPT_r = 1641,                              /* -r */
  OPT_remap = 1642,                          /* -remap */
  OPT_reverse_sort = 1643,                   /* -reverse-sort */
  OPT_s = 1644,                              /* -s */
  OPT_save_temps = 1645,                     /* -save-temps */
  OPT_save_temps_ = 1646,                    /* -save-temps= */
  OPT_shared = 1647,                         /* -shared */
  OPT_shared_libgcc = 1648,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1649,               /* -shared-libphobos */
  OPT_size_sort = 1650,                      /* -size-sort */
  /* OPT_specs = 1651, */                    /* -specs */
  OPT_specs_ = 1652,                         /* -specs= */
  OPT_static = 1653,                         /* -static */
  OPT_static_libasan = 1654,                 /* -static-libasan */
  OPT_static_libgcc = 1655,                  /* -static-libgcc */
  OPT_static_libgfortran = 1656,             /* -static-libgfortran */
  OPT_static_libgo = 1657,                   /* -static-libgo */
  OPT_static_liblsan = 1658,                 /* -static-liblsan */
  OPT_static_libmpx = 1659,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1660,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1661,               /* -static-libphobos */
  OPT_static_libstdc__ = 1662,               /* -static-libstdc++ */
  OPT_static_libtsan = 1663,                 /* -static-libtsan */
  OPT_static_libubsan = 1664,                /* -static-libubsan */
  OPT_static_pie = 1665,                     /* -static-pie */
  /* OPT_std_c__03 = 1666, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1667, */                /* -std=c++0x */
  OPT_std_c__11 = 1668,                      /* -std=c++11 */
  OPT_std_c__14 = 1669,                      /* -std=c++14 */
  OPT_std_c__17 = 1670,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1671, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1672, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1673, */                /* -std=c++20 */
  OPT_std_c__2a = 1674,                      /* -std=c++2a */
  OPT_std_c__98 = 1675,                      /* -std=c++98 */
  OPT_std_c11 = 1676,                        /* -std=c11 */
  OPT_std_c17 = 1677,                        /* -std=c17 */
  /* OPT_std_c18 = 1678, */                  /* -std=c18 */
  /* OPT_std_c1x = 1679, */                  /* -std=c1x */
  OPT_std_c2x = 1680,                        /* -std=c2x */
  /* OPT_std_c89 = 1681, */                  /* -std=c89 */
  OPT_std_c90 = 1682,                        /* -std=c90 */
  OPT_std_c99 = 1683,                        /* -std=c99 */
  /* OPT_std_c9x = 1684, */                  /* -std=c9x */
  OPT_std_f2003 = 1685,                      /* -std=f2003 */
  OPT_std_f2008 = 1686,                      /* -std=f2008 */
  OPT_std_f2008ts = 1687,                    /* -std=f2008ts */
  OPT_std_f2018 = 1688,                      /* -std=f2018 */
  OPT_std_f95 = 1689,                        /* -std=f95 */
  OPT_std_gnu = 1690,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1691, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1692, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1693,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1694,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1695,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1696, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1697, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1698, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1699,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1700,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1701,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1702,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1703, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1704, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1705,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1706, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1707,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1708,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1709, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1710, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1711,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1712, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1713, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1714, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1715, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1716, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1717,                     /* -std=legacy */
  OPT_symbol_ = 1718,                        /* -symbol= */
  OPT_symbolic = 1719,                       /* -symbolic */
  OPT_t = 1720,                              /* -t */
  OPT_time = 1721,                           /* -time */
  OPT_time_ = 1722,                          /* -time= */
  OPT_traditional = 1723,                    /* -traditional */
  OPT_traditional_cpp = 1724,                /* -traditional-cpp */
  OPT_tree_stats = 1725,                     /* -tree-stats */
  OPT_trigraphs = 1726,                      /* -trigraphs */
  OPT_type_stats = 1727,                     /* -type-stats */
  OPT_u = 1728,                              /* -u */
  OPT_undef = 1729,                          /* -undef */
  OPT_v = 1730,                              /* -v */
  OPT_version = 1731,                        /* -version */
  OPT_w = 1732,                              /* -w */
  OPT_wrapper = 1733,                        /* -wrapper */
  OPT_x = 1734,                              /* -x */
  OPT_z = 1735,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
